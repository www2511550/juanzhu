...
<body>
    ...
    <div class="tk-header-top">
        <div class="page-all clearfix">
            专注单品、极致转化！ 
            <a href="login.html" class="reg">[登陆]</a>
            <a href="register.html" class="reg">[注册]</a>
            <a href="" class="fr">加入淘客秘书QQ群></a>
        </div>
    </div>
    <div class="page-all">
        <a class="tk-logo" href="/"><img src="http://g.ligoucdn.cn/taokemishu/1.0/img/reg/login_03.png"></a>
    </div>
</div>
    <div class="tk-container">
        <div class="login-box">
            <div class="login-box-warp">
                <h1 class="login-title">欢迎登陆 <span class="fr">还没有账号？<a href="/home/index/register">免费注册</a></span></h1>
                <form start-id="verify" data-ajax="true" id="login_form" action="/Login/dologin" method="post">
                    <div class="form-group">
                        <label for></label>
                        <input required type="email" name="mail" placeholder="邮箱"></input>
                    </div>
                    <div class="form-group">
                        <label for></label>
                        <input required type="password" name="password" placeholder="密码"></input>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="login-sub">立即登录</button>
                    </div>
                    <a href="/Retrieve/index" class="lost-psword fr">忘记密码？</a>
                </form>
            </div>
        </div>
    </div>
