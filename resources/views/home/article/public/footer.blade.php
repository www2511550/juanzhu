<footer class="footer">
    ...
    <div class="container copy-right">
        ...
        <span>Copyright © <a href="#">卷猪网</a> <a href="#" target="_blank">粤ICP备16100236号</a>
            &nbsp;<a href="#" target="_blank"><i class="i-wj"></i>京公网安备 粤ICP备16100236号</a>&nbsp;&nbsp;&nbsp;<em class="bull-right">本站由</em><i class="icon-aliyun" style="width: 70px;background-size: 100%;left: 7px;"></i><em class="bull-em">提供计算与安全服务</em>
        </span>
        <div class="footer-icon-list pull-right">
            <ul class="Qr-codee">
                <a><li class="Qr-code-footer">
                        <div class="app-qrcode"><img src="/huxiu/images/weixin_erweima.png"></div>
                        <i class="icon icon-footer icon-footer-wx"></i>
                    </li>
                </a>
                <a><li class="Qr-code-footer">
                        <div class="app-qrcode"><img src="/huxiu/images/app_erweima.png"></div>
