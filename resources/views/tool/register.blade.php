...
<div class="login-main"  data-back-url="@if(isset($_GET['backUrl']) && $_GET['backUrl']){{ $_GET['backUrl'] }} @endif">
    ...
    <form class="layui-form">
        ...
        <div class="layui-input-inline">
            <div class="layui-inline" style="width: 85%">
                <input type="password" id="rpwd" name="pwd" required  lay-verify="required" placeholder="请确认密码" autocomplete="off" class="layui-input">
            </div>
            <!-- 对号 -->
            <div class="layui-inline">
        ...
        <hr style="width: 85%" />
        <p style="width: 85%"><a href="/tool/login" class="fl">已有账号？立即登录</a>
