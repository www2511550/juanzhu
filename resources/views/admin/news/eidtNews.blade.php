...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/admin/news/addNews" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="intro" value="{{ $data->intro }}" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" id="url1" name="cover" class="input tips" style="width:25%; float:left;" value="{{ $data->cover }}" data-toggle="hover" data-place="right" data-image="/{{ $data->cover }}"  />
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <div class="button-group radio">
                        ...
                        <label class="button @if($data->is_top == 1) active @endif">
                            <span class="icon icon-check"></span>
                            <input name="is_top" value="1" type="radio" @if($data->is_top == 1) checked="checked" @endif>是
                        </label>

                        <label class="button @if($data->is_top == 0) active @endif"><span class="icon icon-times"></span>
                            <input name="is_top" value="0"  type="radio" @if($data->is_top == 0) checked="checked" @endif>否
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <script type="text/plain" id="myEditor" style="width:60%;height:1000px;" name="content">
                        {!! $data->content !!}
                    </script>
