...
?>
	...
	<strong><span class="duzhe"><?php commentauthor(); ?></span></strong><span class="reply_tz"><?php printf( __('&nbsp;%1$s %2$s', 'Nana'), get_comment_date( 'Y-m-d' ),  get_comment_time('H:i') ); ?><?php comment_reply_link(array_merge( $args, array('reply_text' => '&nbsp;<span class="dashicons dashicons-undo"></span>', 'add_below' =>$add_below, 'depth' => $depth, 'max_depth' => 10000))); ?></span><br/>
	<?php } else { ?>
		<strong><span class="duzhe"><?php commentauthor(); ?></span></strong><span class="reply_t"><?php comment_reply_link(array_merge( $args, array('reply_text' => '&nbsp;@回复', 'add_below' =>$add_below, 'depth' => $depth, 'max_depth' => 10000))); ?></span><br/>
		<span class="comment-meta commentmetadata">
			<span class="comment-aux">
				<?php echo '<span class="xiaoshi">发表于</span>';printf( __('&nbsp;%1$s %2$s', 'Nana'), get_comment_date( 'Y-m-d' ),  get_comment_time('H:i') ); ?>
				<?php
