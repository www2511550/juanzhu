...
function pagenavi( $before = '', $after = '', $p = 3 ) {
	...
	if ( $paged > 1 ) {echo '<span class="prev">'; p_link( $paged - 1, '上页', '<i class="dashicons dashicons-arrow-left-alt2" style="height: auto;"></i>' );echo '</span>';}
	...
	if ( $paged < $max_page ) {echo '<span class="next">'; p_link( $paged + 1,'下页', '<i class="dashicons dashicons-arrow-right-alt2" style="height: auto;"></i>' );echo '</span>';}
	echo '</div></nav>'.$after."\n";
}
