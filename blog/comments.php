			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				<div id="comment-author-info">
					<p class="comment-form-author">
						<input id="qqinfo" maxlength="12" name="u" type="text"  placeholder="输入QQ号可快速填写" onblur="qiuye()" value="" />
						<label>QQ</label>
					</p>
					<p class="comment-form-author">
...
<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
	<nav id="comment-navigation">
		<div class="pagination"><?php paginate_comments_links('prev_text=<i class="dashicons dashicons-arrow-left-alt2" style="height: auto;"></i>&next_text=<i class="dashicons dashicons-arrow-right-alt2" style="height: auto;"></i>'); ?></div>
	</nav>
	<div class="clear"></div>
